      ...
      <main className="max-w-5xl mx-auto px-6 pt-28 pb-20">
        ...
        <div className="max-w-3xl">
          <h1 className="text-4xl md:text-5xl font-bold text-[#191919] leading-tight">
            Compete stronger <i className="text-[#3276FD]">with a resume.</i>
          </h1>
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          <div className="bg-white/80 backdrop-blur rounded-2xl shadow-lg border border-gray-200 p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
            ...
            <p className="mt-3 text-[15px] text-[#6F7580] leading-relaxed">
              Show the languages, frameworks, and tools you can actually use.
            </p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur rounded-2xl shadow-lg border border-gray-200 p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
            ...
            <p className="mt-3 text-[15px] text-[#6F7580] leading-relaxed">
              Add apps, bots, websites, or experiments with one clear impact line.
            </p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur rounded-2xl shadow-lg border border-gray-200 p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
            ...
            <p className="mt-3 text-[15px] text-[#6F7580] leading-relaxed">
              A polished resume makes you easier to remember beyond the event.
            </p>
          </div>
        </div>
        ...
        <div className="border-t border-gray-100 pt-16 mt-16">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-3xl md:text-4xl font-bold text-[#191919] leading-snug">
              First impressions still <i className="text-[#3276FD]">matter.</i>
            </h2>

            <p className="mt-4 text-sm md:text-base text-[#6F7580] leading-relaxed">
              In fast-paced events, people form opinions quickly. A strong resume
              helps others understand what you bring to the table before the pitch,
              the build, or the final demo.
            </p>
          </div>
        </div>
