            ...
            <div key={index} className={additionalInfoStyles.languageItem}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
                <Input
                  ...
                  value={lang || ""}
                  onChange={({ target }) => updateArrayItem("languages", index, null, target.value)}
                />
              </div>
              {languages.length > 1 && (
                <button
...
export const SkillsInfoForm = ({ skillsInfo, updateSkillArrayItem, addSkillItem, removeSkillItem }) => {
  const technicalSkills = skillsInfo?.technical || [""];
  const softSkills = skillsInfo?.soft || [""];

  return (
    <div className={skillsInfoStyles.container}>
      <h2 className={skillsInfoStyles.heading}>Skills</h2>
      <div className="space-y-6 mb-8">
        <h3 className="text-base font-bold text-slate-700">Technical Skills</h3>
          ...
          <div key={index} className={skillsInfoStyles.item}>
            ...
            {technicalSkills.length > 1 && (
              <button
                type="button"
                className={commonStyles.trashButton}
                onClick={() => removeSkillItem("technical", index)}
              >
                <Trash2 size={16} />
              </button>
            )}
        ...
        >
          <Plus size={16} /> Add Technical Skill
        </button>
      </div>

      <div className="space-y-6 mb-6">
        <h3 className="text-base font-bold text-slate-700">Soft Skills</h3>
          ...
          <div key={index} className={skillsInfoStyles.item}>
            ...
            {softSkills.length > 1 && (
              <button
                type="button"
                className={commonStyles.trashButton}
                onClick={() => removeSkillItem("soft", index)}
              >
                <Trash2 size={16} />
              </button>
            )}
...
// InternshipExperienceForm Component
          ...
          <div key={index} className={workExperienceStyles.item}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Input
                ...
                onChange={({ target }) => updateArrayItem(index, "duration", target.value)}
              />
            </div>
...
// HERE I WILL GET HOW TO FILL AS WELL AS IT WILL BE LIKE DATA WILL BE PASSED HERE.
